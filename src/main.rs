...
fn bench<N: Unsigned>(config: &Config, output: &mut Writer<File>) {
    ...
    let (ops_per_sec, peak_mem, avg_mem, peak_garb, avg_garb) = match config.mm {
        MM::NR => match config.ds {
            ...
            DS::SkipList => {
                bench_map_nr::<nr::SkipList<usize, usize>>(config, PrefillStrategy::Decreasing)
            }
            DS::BonsaiTree => {
        ...
        MM::EBR => match config.ds {
            ...
            DS::SkipList => {
                bench_map_ebr::<ebr::SkipList<usize, usize>, N>(config, PrefillStrategy::Decreasing)
            }
        },
        MM::PEBR => match config.ds {
            ...
            DS::SkipList => bench_map_pebr::<pebr::SkipList<usize, usize>, N>(
                config,
                PrefillStrategy::Decreasing,
            ),
        },
        MM::HP => match config.ds {
            ...
            DS::SkipList => {
                bench_map_hp::<hp::SkipList<usize, usize>, N>(config, PrefillStrategy::Decreasing)
            }
            DS::BonsaiTree => {
        ...
        MM::HP_PP => match config.ds {
            ...
            DS::SkipList => bench_map_hp::<hp_pp::SkipList<usize, usize>, N>(
                config,
                PrefillStrategy::Decreasing,
            ),
        ...
        MM::CDRC_EBR => match config.ds {
            DS::HList => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::HList<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::HMList => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::HMList<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::HHSList => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::HHSList<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::HashMap => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::HashMap<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::NMTree => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::NMTreeMap<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Random),
            DS::SkipList => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::SkipList<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::BonsaiTree => bench_map_cdrc::<
                ...
                N,
            >(config, PrefillStrategy::Random),
            DS::EFRBTree => bench_map_cdrc::<
                cdrc_rs::CsEBR,
                cdrc::EFRBTree<usize, usize, cdrc_rs::CsEBR>,
                N,
            >(config, PrefillStrategy::Random),
        },
        MM::CDRC_HP => match config.ds {
            DS::HList => {
                bench_map_cdrc::<cdrc_rs::CsHP, cdrc::HList<usize, usize, cdrc_rs::CsHP>, N>(
                    config,
                    PrefillStrategy::Decreasing,
                )
            }
            DS::HMList => bench_map_cdrc::<
                cdrc_rs::CsHP,
                cdrc::HMList<usize, usize, cdrc_rs::CsHP>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::HHSList => bench_map_cdrc::<
                cdrc_rs::CsHP,
                cdrc::HHSList<usize, usize, cdrc_rs::CsHP>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::HashMap => bench_map_cdrc::<
                cdrc_rs::CsHP,
                cdrc::HashMap<usize, usize, cdrc_rs::CsHP>,
                N,
            >(config, PrefillStrategy::Decreasing),
            DS::NMTree => bench_map_cdrc::<
                cdrc_rs::CsHP,
                cdrc::NMTreeMap<usize, usize, cdrc_rs::CsHP>,
                N,
            >(config, PrefillStrategy::Random),
            DS::SkipList => bench_map_cdrc::<
                cdrc_rs::CsHP,
            ...
            DS::EFRBTree => bench_map_cdrc::<
                cdrc_rs::CsHP,
                cdrc::EFRBTree<usize, usize, cdrc_rs::CsHP>,
                N,
            >(config, PrefillStrategy::Random),
        },
        ...
        MM::VBR => match config.ds {
            ...
            DS::SkipList => {
                bench_map_vbr::<vbr::SkipList<usize, usize>>(config, PrefillStrategy::Decreasing)
            }
        ...
        match self {
            PrefillStrategy::Random => {
                ...
                scope(|s| {
                    for t in 0..threads {
                        s.spawn(move |_| {
                            let cs = unsafe { &cdrc_rs::Cs::unprotected() };
...
fn bench_map_vbr<M: vbr::ConcurrentMap<usize, usize> + Send + Sync>(
    ...
    let local = &M::local(global);
    let map = &M::new(local);
    strategy.prefill_vbr(config, map, global);
