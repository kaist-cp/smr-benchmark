use he::{set_batch_capacity, Domain, GLOBAL_GARBAGE_COUNT};
...
use smr_benchmark::ds_impl::he::{ConcurrentMap, HHSList, HList, HMList, HashMap, NMTreeMap};
...
fn bench_map<M: ConcurrentMap<usize, usize> + Send + Sync>(
    ...
    match config.bag_size {
        BagSize::Small => set_batch_capacity(512),
        BagSize::Large => set_batch_capacity(4096),
    }
